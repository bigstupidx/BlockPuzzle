...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
       ...
       /* if (String.Equals(item.productID, "tetris.item1", StringComparison.Ordinal))
        ...
        if (String.Equals(item.productID, "com.blast.bloxtetris.20rubies", StringComparison.Ordinal))
            AppsFlyerMMP.InAppPurchase20Rubies();
        else if (String.Equals(item.productID, "com.blast.bloxtetris.50rubies", StringComparison.Ordinal))
            AppsFlyerMMP.InAppPurchase50Rubies();
        else if (String.Equals(item.productID, "com.blast.bloxtetris.120rubies", StringComparison.Ordinal))
            AppsFlyerMMP.InAppPurchase120Rubies();
        else if (String.Equals(item.productID, "com.blast.bloxtetris.200rubies", StringComparison.Ordinal))
            AppsFlyerMMP.InAppPurchase200Rubies();
